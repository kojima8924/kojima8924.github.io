...
- Heroから完全版PDF、GitHubへ直接移動できる。実績の根拠は「実案件1件（開発中・匿名）／主要OSS 2件／査読論文筆頭著者」として表示。Hero直下は経歴（学歴・資格）、続いてAIによる要約（4AI・初期状態は折りたたみ）の順で配置
...
- 研究実績は評価設計の根拠として要点と論文・ポスターへの導線に集約。経歴は独立セクションとしてHero直下に掲載
