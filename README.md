...
- 掲載許可取得前のクライアント案件は、開発中であることだけを掲載
- Clage Cook、ChromiumforA、scriptveditを主要作品として掲載
- ChromiumforAは現行仕様の通常表示／AI評価後に加え、日本語検索でのAI再評価、FAB、ページ要約の実機画面と2倍速動画を掲載。動画ダウンロード機能は非掲載
- 主要作品と過去作品の画像・動画・技術バッジを表示し、説明文だけを短縮
- 研究実績は要点と論文・ポスターへの導線に集約
- SNS共有画像は生成AIを使わず、HTML/CSSから決定的に描画
- 配布PDFは同じ公開HTMLから生成（A4・6ページ・約20.7 MiB）
